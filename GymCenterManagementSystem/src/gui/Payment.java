    	...
    	if (value == null) {
            ...
            for (int i = 0; i < Data.appointmentList.size(); i++) {
                if (Data.appointmentList.get(i).getId().equals(value)) {
                    ...
                    jLabel9.setText(Data.appointmentList.get(i).getDate());
                    jLabel11.setText(Data.appointmentList.get(i).getTime());
                    jLabel13.setText(String.valueOf(Data.appointmentList.get(i).getCost()));
                }
            }
    	}
